...
// DecodeStringLengths decodes a *encodingpb.StringLengths message from a reader.
func DecodeStringLengths(
	reader xio.Reader,
...
// DecodeStringLengthsRaw decodes raw bytes into a protobuf message, returning the
// number of bytes read and any errors encountered.
func DecodeStringLengthsRaw(
	data []byte,
	msg *encodingpb.StringLengths,
) (int, error) {
