...
// *encodingpb.DoubleMeta is a generic gogo protobuf generated Message type.

// DecodeDoubleMeta decodes a *encodingpb.DoubleMeta message from a reader.
func DecodeDoubleMeta(
	reader xio.Reader,
	msg *encodingpb.DoubleMeta,
...
// DecodeDoubleMetaRaw decodes raw bytes into a protobuf message, returning the
// number of bytes read and any errors encountered.
func DecodeDoubleMetaRaw(
	data []byte,
	msg *encodingpb.DoubleMeta,
) (int, error) {
