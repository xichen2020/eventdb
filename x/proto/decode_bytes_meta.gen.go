...
// *encodingpb.BytesMeta is a generic gogo protobuf generated Message type.

// DecodeBytesMeta decodes a *encodingpb.BytesMeta message from a reader.
func DecodeBytesMeta(
	reader xio.Reader,
	msg *encodingpb.BytesMeta,
...
// DecodeBytesMetaRaw decodes raw bytes into a protobuf message, returning the
// number of bytes read and any errors encountered.
func DecodeBytesMetaRaw(
	data []byte,
	msg *encodingpb.BytesMeta,
) (int, error) {
