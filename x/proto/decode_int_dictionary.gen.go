...
// DecodeIntDictionary decodes a *encodingpb.IntDictionary message from a reader.
...
// DecodeIntDictionaryRaw decodes raw bytes into a protobuf message, returning the
// number of bytes read and any errors encountered.
func DecodeIntDictionaryRaw(
	data []byte,
	msg *encodingpb.IntDictionary,
) (int, error) {
