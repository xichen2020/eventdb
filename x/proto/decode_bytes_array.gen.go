...
// *encodingpb.BytesArray is a generic gogo protobuf generated Message type.

// DecodeBytesArray decodes a *encodingpb.BytesArray message from a reader.
func DecodeBytesArray(
	reader xio.Reader,
	msg *encodingpb.BytesArray,
...
// DecodeBytesArrayRaw decodes raw bytes into a protobuf message, returning the
// number of bytes read and any errors encountered.
func DecodeBytesArrayRaw(
	data []byte,
	msg *encodingpb.BytesArray,
) (int, error) {
