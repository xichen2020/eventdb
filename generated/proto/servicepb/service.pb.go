...
func (*HealthRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_01ce3448173aa706, []int{0}
}
...
func (*HealthResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_01ce3448173aa706, []int{1}
}
...
func (dst *HealthResult) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HealthResult.Merge(dst, src)
}
...
func (*WriteRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_01ce3448173aa706, []int{2}
}
...
func (*WriteResults) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_01ce3448173aa706, []int{3}
}
func (m *WriteResults) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *WriteResults) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_WriteResults.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *WriteResults) XXX_Merge(src proto.Message) {
	xxx_messageInfo_WriteResults.Merge(dst, src)
}
func (m *WriteResults) XXX_Size() int {
	return m.Size()
}
func (m *WriteResults) XXX_DiscardUnknown() {
	xxx_messageInfo_WriteResults.DiscardUnknown(m)
}

var xxx_messageInfo_WriteResults proto.InternalMessageInfo

type RawQueryResults struct {
	Raw                  [][]byte `protobuf:"bytes,1,rep,name=raw" json:"raw,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*RawQueryResults) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_01ce3448173aa706, []int{4}
}
func (m *RawQueryResults) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RawQueryResults) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RawQueryResults.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *RawQueryResults) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RawQueryResults.Merge(dst, src)
}
func (m *RawQueryResults) XXX_Size() int {
	return m.Size()
}
func (m *RawQueryResults) XXX_DiscardUnknown() {
	xxx_messageInfo_RawQueryResults.DiscardUnknown(m)
}

var xxx_messageInfo_RawQueryResults proto.InternalMessageInfo

func (m *RawQueryResults) GetRaw() [][]byte {
	if m != nil {
		return m.Raw
	}
	return nil
...
func (*SingleKeyGroupQueryResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_01ce3448173aa706, []int{5}
}
func (m *SingleKeyGroupQueryResult) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SingleKeyGroupQueryResult) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SingleKeyGroupQueryResult.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *SingleKeyGroupQueryResult) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SingleKeyGroupQueryResult.Merge(dst, src)
}
func (m *SingleKeyGroupQueryResult) XXX_Size() int {
	return m.Size()
}
func (m *SingleKeyGroupQueryResult) XXX_DiscardUnknown() {
	xxx_messageInfo_SingleKeyGroupQueryResult.DiscardUnknown(m)
}

var xxx_messageInfo_SingleKeyGroupQueryResult proto.InternalMessageInfo
...
func (*SingleKeyGroupQueryResults) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_01ce3448173aa706, []int{6}
}
func (m *SingleKeyGroupQueryResults) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SingleKeyGroupQueryResults) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SingleKeyGroupQueryResults.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *SingleKeyGroupQueryResults) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SingleKeyGroupQueryResults.Merge(dst, src)
}
func (m *SingleKeyGroupQueryResults) XXX_Size() int {
	return m.Size()
}
func (m *SingleKeyGroupQueryResults) XXX_DiscardUnknown() {
	xxx_messageInfo_SingleKeyGroupQueryResults.DiscardUnknown(m)
}

var xxx_messageInfo_SingleKeyGroupQueryResults proto.InternalMessageInfo
...
func (*MultiKeyGroupQueryResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_01ce3448173aa706, []int{7}
}
func (m *MultiKeyGroupQueryResult) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MultiKeyGroupQueryResult) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MultiKeyGroupQueryResult.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *MultiKeyGroupQueryResult) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MultiKeyGroupQueryResult.Merge(dst, src)
}
func (m *MultiKeyGroupQueryResult) XXX_Size() int {
	return m.Size()
}
func (m *MultiKeyGroupQueryResult) XXX_DiscardUnknown() {
	xxx_messageInfo_MultiKeyGroupQueryResult.DiscardUnknown(m)
}

var xxx_messageInfo_MultiKeyGroupQueryResult proto.InternalMessageInfo
...
func (*MultiKeyGroupQueryResults) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_01ce3448173aa706, []int{8}
}
func (m *MultiKeyGroupQueryResults) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MultiKeyGroupQueryResults) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MultiKeyGroupQueryResults.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *MultiKeyGroupQueryResults) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MultiKeyGroupQueryResults.Merge(dst, src)
}
func (m *MultiKeyGroupQueryResults) XXX_Size() int {
	return m.Size()
}
func (m *MultiKeyGroupQueryResults) XXX_DiscardUnknown() {
	xxx_messageInfo_MultiKeyGroupQueryResults.DiscardUnknown(m)
}

var xxx_messageInfo_MultiKeyGroupQueryResults proto.InternalMessageInfo
...
func (*GroupedQueryResults) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_01ce3448173aa706, []int{9}
}
func (m *GroupedQueryResults) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GroupedQueryResults) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GroupedQueryResults.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *GroupedQueryResults) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GroupedQueryResults.Merge(dst, src)
}
func (m *GroupedQueryResults) XXX_Size() int {
	return m.Size()
}
func (m *GroupedQueryResults) XXX_DiscardUnknown() {
	xxx_messageInfo_GroupedQueryResults.DiscardUnknown(m)
}

var xxx_messageInfo_GroupedQueryResults proto.InternalMessageInfo
...
func (*TimeBucketQueryResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_01ce3448173aa706, []int{10}
}
func (m *TimeBucketQueryResult) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TimeBucketQueryResult) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TimeBucketQueryResult.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *TimeBucketQueryResult) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TimeBucketQueryResult.Merge(dst, src)
}
func (m *TimeBucketQueryResult) XXX_Size() int {
	return m.Size()
}
func (m *TimeBucketQueryResult) XXX_DiscardUnknown() {
	xxx_messageInfo_TimeBucketQueryResult.DiscardUnknown(m)
}

var xxx_messageInfo_TimeBucketQueryResult proto.InternalMessageInfo
...
func (*TimeBucketQueryResults) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_01ce3448173aa706, []int{11}
}
func (m *TimeBucketQueryResults) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TimeBucketQueryResults) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TimeBucketQueryResults.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *TimeBucketQueryResults) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TimeBucketQueryResults.Merge(dst, src)
}
func (m *TimeBucketQueryResults) XXX_Size() int {
	return m.Size()
}
func (m *TimeBucketQueryResults) XXX_DiscardUnknown() {
	xxx_messageInfo_TimeBucketQueryResults.DiscardUnknown(m)
}

var xxx_messageInfo_TimeBucketQueryResults proto.InternalMessageInfo
...
func (c *eventdbClient) Health(ctx context.Context, in *HealthRequest, opts ...grpc.CallOption) (*HealthResult, error) {
	...
	err := c.cc.Invoke(ctx, "/servicepb.eventdb/Health", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eventdbClient) Write(ctx context.Context, in *WriteRequest, opts ...grpc.CallOption) (*WriteResults, error) {
	...
	err := c.cc.Invoke(ctx, "/servicepb.eventdb/Write", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eventdbClient) QueryRaw(ctx context.Context, in *RawQuery, opts ...grpc.CallOption) (*RawQueryResults, error) {
	...
	err := c.cc.Invoke(ctx, "/servicepb.eventdb/QueryRaw", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eventdbClient) QueryGrouped(ctx context.Context, in *GroupedQuery, opts ...grpc.CallOption) (*GroupedQueryResults, error) {
	...
	err := c.cc.Invoke(ctx, "/servicepb.eventdb/QueryGrouped", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eventdbClient) QueryTimeBucket(ctx context.Context, in *TimeBucketQuery, opts ...grpc.CallOption) (*TimeBucketQueryResults, error) {
	...
	err := c.cc.Invoke(ctx, "/servicepb.eventdb/QueryTimeBucket", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (m *RawQueryResults) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Raw) > 0 {
		for _, b := range m.Raw {
			dAtA[i] = 0xa
			i++
			i = encodeVarintService(dAtA, i, uint64(len(b)))
			i += copy(dAtA[i:], b)
		}
	}
	return i, nil
...
func (m *RawQueryResults) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Raw = append(m.Raw, make([]byte, postIndex-iNdEx))
			copy(m.Raw[len(m.Raw)-1], dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipService(dAtA[iNdEx:])
...
func init() {
	proto.RegisterFile("github.com/xichen2020/eventdb/generated/proto/servicepb/service.proto", fileDescriptor_service_01ce3448173aa706)
}

var fileDescriptor_service_01ce3448173aa706 = []byte{
	...
	,
}
