...
func (*BytesMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_bytes_0d6f23f7d55be693, []int{0}
}
func (m *BytesMeta) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BytesMeta) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BytesMeta.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *BytesMeta) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BytesMeta.Merge(dst, src)
}
func (m *BytesMeta) XXX_Size() int {
	return m.Size()
}
func (m *BytesMeta) XXX_DiscardUnknown() {
	xxx_messageInfo_BytesMeta.DiscardUnknown(m)
}

var xxx_messageInfo_BytesMeta proto.InternalMessageInfo
...
func (*BytesArray) Descriptor() ([]byte, []int) {
	return fileDescriptor_bytes_0d6f23f7d55be693, []int{1}
}
...
func init() {
	proto.RegisterFile("github.com/xichen2020/eventdb/generated/proto/encodingpb/bytes.proto", fileDescriptor_bytes_0d6f23f7d55be693)
}

var fileDescriptor_bytes_0d6f23f7d55be693 = []byte{
