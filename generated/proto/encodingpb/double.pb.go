...
func (*DoubleMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_double_1bc4bc8a7642bac3, []int{0}
}
func (m *DoubleMeta) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DoubleMeta) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DoubleMeta.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *DoubleMeta) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DoubleMeta.Merge(dst, src)
}
func (m *DoubleMeta) XXX_Size() int {
	return m.Size()
}
func (m *DoubleMeta) XXX_DiscardUnknown() {
	xxx_messageInfo_DoubleMeta.DiscardUnknown(m)
}

var xxx_messageInfo_DoubleMeta proto.InternalMessageInfo
...
func init() {
	proto.RegisterFile("github.com/xichen2020/eventdb/generated/proto/encodingpb/double.proto", fileDescriptor_double_1bc4bc8a7642bac3)
}

var fileDescriptor_double_1bc4bc8a7642bac3 = []byte{
