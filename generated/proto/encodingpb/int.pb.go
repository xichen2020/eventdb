...
func (*IntMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_int_78fa8b2d4cfe69d9, []int{0}
}
...
func (*IntDictionary) Descriptor() ([]byte, []int) {
	return fileDescriptor_int_78fa8b2d4cfe69d9, []int{1}
}
...
func init() {
	proto.RegisterFile("github.com/xichen2020/eventdb/generated/proto/encodingpb/int.proto", fileDescriptor_int_78fa8b2d4cfe69d9)
}

var fileDescriptor_int_78fa8b2d4cfe69d9 = []byte{
