...
//go:generate sh -c "mockgen -package=encoding $PACKAGE/encoding RewindableIntIterator,RewindableStringIterator,ForwardDoubleIterator,RewindableBoolIterator | genclean -pkg $PACKAGE/encoding -out $GOPATH/src/$PACKAGE/encoding/encoding_mock.go"
