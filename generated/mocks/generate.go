...
//go:generate sh -c "mockgen -package=document $PACKAGE/document DocIDSetIterator | genclean -pkg $PACKAGE/document -out $GOPATH/src/$PACKAGE/document/document_mock.go"
